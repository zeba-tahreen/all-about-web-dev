      ...
      <Container className='mainDiv'>
        ...
        <div className="m-1 quiz-box">
          ...
          <ul>
                ...
                <li>Write code for the website, using programming languages such as Java, C, C++, JavaScript and so on.</li>
                ...
                <li>Integrate graphics, audio, and video into the websit.</li>
        ...
        <a className="pageRight" href="/developers">Next</a>
      <br/>
        <hr />
      </Container>
  </Styles>
